...
do
    ...
    kubectl get pods -o yaml -A | egrep "namespace:|:443" | egrep -v "ownerReferences|--|monit|prometheus|kubesystem|linkerd|resourceVersion|security_protocol|check_hostname|False" | awk '{ if ($1 == "namespace:") { namespace = $2 } else if ($1 == "value:") { printf( ",""%s,%s\n", namespace, $2) } }' >> single_csv.csv
